...
#' @examples
#' GEO_AO(100, 90, 0.05, 20/252, 0.20, 20)
#' @returns
#' Method Generates volatility and interest rates that are plugged back into the
#'  Black-Scholes Formula to produce a Geometric Average Price Estimate
#' @export
